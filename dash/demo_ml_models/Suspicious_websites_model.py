...
# Sample dataset with two columns: 'WebString' and 'Label'


# Convert the dictionary to a DataFrame


# Initialize the model with the path to your dataset
model = TextModel('demo_datasets/suspicious_websites_dataset.csv')
...
# Make a prediction and generate an explanation for a sample input
user_input = "This website is potentially dangerous"
features, weights, exp = model.predict_and_explain(user_input)
...
fig, probas = model.generate_lime_explanation(user_input)
print("Probabilities:", probas)

# Show the LIME explanation plot (if you're running this in a Jupyter notebook)
# fig.show()
